...
<script>
    ...
    let table= $('#data-table').DataTable({
        ...
        ajax: URL_BASE+'/api/evento',
        columns:[
            {data:"id_tipo_evento",render:function(data, type, row){
                return `<a href="#winEdit" data-registro='${URL_BASE}/evento/${data}/edit'"
            ...
            {data:"id_status",render:function(data, type, row){
                ...
                <a href="#winEditEstatus" data-registro="${URL_BASE}/evento/${row.id_tipo_evento}"
