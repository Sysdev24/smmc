<table id="data-table" class="table table-hover" style="width:100%">
    <thead>
        ...
        <th style="text-align: center" width="80%">PROCESO</th>
...
<script>
    ...
    let table= $('#data-table').DataTable({
        ...
        ajax: URL_BASE+'/api/proceso_relacionado',
        columns:[
            {data:"id_proceso_relacionado",render:function(data, type, row){
                return `<a href="#winEdit" data-registro='${URL_BASE}/proceso_relacionado/${data}/edit'"
            ...
            {data:"id_status",render:function(data, type, row){
                ...
                <a href="#winEditEstatus" data-registro="${URL_BASE}/proceso_relacionado/${row.id_proceso_relacionado}"
