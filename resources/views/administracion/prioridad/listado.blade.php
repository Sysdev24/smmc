<table id="data-table" class="table table-hover" style="width:100%">
    <thead>
        ...
        <th style="text-align: center" width="80%">PRIORIDAD </th>
...
<script>
    ...
    let table= $('#data-table').DataTable({
        ...
        ajax: URL_BASE+'/api/prioridad',
        columns:[
            {data:"id_prioridad",render:function(data, type, row){
                return `<a href="#winEdit" data-registro='${URL_BASE}/prioridad/${data}/edit'"
            ...
            {data:"id_status",render:function(data, type, row){
                ...
                <a href="#winEditEstatus" data-registro="${URL_BASE}/prioridad/${row.id_prioridad}"
