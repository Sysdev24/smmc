<table id="data-table" class="table table-hover" style="width:100%">
    <thead>
        ...
        <th style="text-align: center" width="80%">INSUMO </th>
...
<script>
    ...
    let table= $('#data-table').DataTable({
        ...
        ajax: URL_BASE+'/api/insumo',
        columns:[
            {data:"id_insumo",render:function(data, type, row){
                return `<a href="#winEdit" data-registro='${URL_BASE}/insumo/${data}/edit'"
            ...
            {data:"id_status",render:function(data, type, row){
                ...
                <a href="#winEditEstatus" data-registro="${URL_BASE}/insumo/${row.id_insumo}"
