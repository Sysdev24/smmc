<table id="data-table" class="table table-hover" style="width:100%">
    <thead>
        ...
        <th style="text-align: center" width="80%">EVENTO</th>
...
<script>
    ...
    let table= $('#data-table').DataTable({
        ...
        ajax: URL_BASE+'/api/tipo_evento',
        columns:[
            {data:"id_tipo_evento",render:function(data, type, row){
                return `<a href="#winEdit" data-registro='${URL_BASE}/tipo_evento/${data}/edit'"
            ...
            {data:"id_status",render:function(data, type, row){
                ...
                <a href="#winEditEstatus" data-registro="${URL_BASE}/tipo_evento/${row.id_tipo_evento}"
