    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-light">
                <h5 class="modal-title " id="exampleModalLongTitle">REGISTRAR MINUTA</h5>
                <a type="button" class="close" data-dismiss="modal">
                    <span aria-hidden="true" class="icofont-close-squared-alt"></span>
                </a>
            </div>
            <div class="modal-body">
                @include('administracion/tipo_evento/create')
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="winEditEstatus" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-light">
                <h5 class="modal-title " id="exampleModalLongTitle">ELIMINAR MINUTA</h5>
...
<div class="modal fade" id="winEdit" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-light">
                <h5 class="modal-title " id="exampleModalLongTitle">MODIFICAR MINUTA</h5>
                <button type="button" class="close" data-dismiss="modal">
                    <span aria-hidden="true" class="icofont-close-squared-alt"></span>
                </button>
            </div>
...
<div class="container">
    <div class="breadcrumbs">
        <h2 class="mb-3 ml-3 font-weight-bold"><a href="{{route('tipo_evento.index')}}">
                <span class="icofont-home"></span>
            </a>TIPO DE MENCIÓN</h2>
    </div>
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex mr-1 mb-2 justify-content-between">
                        ...
                        <div class="text-center mb-3 ">
                            <a id="openAddWin" href="#winAgregarRegistro" class="btn btn-primary btn-md d-md-flex px-4 "
                                ...
                                data-target="#winAgregarRegistro" title="Agregar nuevo tipo de minuta">
                    ...
                    <div id="tabla_registros" class="tabla_movimientos">
                        @include('administracion.tipo_evento.listado')
                    </div>
